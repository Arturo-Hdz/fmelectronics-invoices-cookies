...
import com.fmelectronics.orders.payload.response.MessageResponse;
...
import com.fmelectronics.orders.payload.request.LoginRequest;
import com.fmelectronics.orders.payload.request.SignupRequest;
import com.fmelectronics.orders.payload.response.UserInfoResponse;
import com.fmelectronics.orders.repository.RoleRepository;
import com.fmelectronics.orders.security.services.RefreshTokenService;
...
public class AuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    User user = new User(signUpRequest.getUsername(), signUpRequest.getEmail(),
                         ...
                         signUpRequest.getAddress(), signUpRequest.getPhone_number());
